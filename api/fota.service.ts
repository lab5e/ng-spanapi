...
export interface CreateLabeledFirmwareRequestParams {
    ...
    version?: string;
    label?: string;
    imageRefImageRef?: string;
    imageRefCreatedAt?: string;
    imageRefFileName?: string;
    imageRefLength?: string;
    imageRefChecksum?: string;
    imageRefSha256?: string;
}
...
export class FotaService {
    ...
    public createLabeledFirmware(requestParameters: CreateLabeledFirmwareRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        const imageRefImageRef = requestParameters.imageRefImageRef;
        const imageRefCreatedAt = requestParameters.imageRefCreatedAt;
        const imageRefFileName = requestParameters.imageRefFileName;
        const imageRefLength = requestParameters.imageRefLength;
        const imageRefChecksum = requestParameters.imageRefChecksum;
        const imageRefSha256 = requestParameters.imageRefSha256;
        ...
        if (imageRefImageRef !== undefined && imageRefImageRef !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>imageRefImageRef, 'imageRef.imageRef');
        }
        if (imageRefCreatedAt !== undefined && imageRefCreatedAt !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>imageRefCreatedAt, 'imageRef.createdAt');
        }
        if (imageRefFileName !== undefined && imageRefFileName !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>imageRefFileName, 'imageRef.fileName');
        }
        if (imageRefLength !== undefined && imageRefLength !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>imageRefLength, 'imageRef.length');
        }
        if (imageRefChecksum !== undefined && imageRefChecksum !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>imageRefChecksum, 'imageRef.checksum');
        }
        if (imageRefSha256 !== undefined && imageRefSha256 !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>imageRefSha256, 'imageRef.sha256');
        }
