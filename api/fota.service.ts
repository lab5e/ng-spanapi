...
// @ts-ignore
import { AssignTargetImageResponse } from '../model/assignTargetImageResponse';
// @ts-ignore
import { ClearFirmwareErrorResponse } from '../model/clearFirmwareErrorResponse';
// @ts-ignore
import { CreateFirmwareBody } from '../model/createFirmwareBody';
// @ts-ignore
import { CreateLabeledFirmwareResponse } from '../model/createLabeledFirmwareResponse';
// @ts-ignore
...
// @ts-ignore
import { GetImageStateResponse } from '../model/getImageStateResponse';
// @ts-ignore
import { ListFirmwareResponse } from '../model/listFirmwareResponse';
// @ts-ignore
import { ListImageStatesResponse } from '../model/listImageStatesResponse';
// @ts-ignore
import { ListImageVersionHistoryResponse } from '../model/listImageVersionHistoryResponse';
// @ts-ignore
import { ListLabeledFirmwareResponse } from '../model/listLabeledFirmwareResponse';
// @ts-ignore
import { RpcStatus } from '../model/rpcStatus';
// @ts-ignore
import { UpdateFirmwareBody } from '../model/updateFirmwareBody';
...
export interface AssignTargetImageRequestParams {
    collectionId: string;
    imageId: string;
    label?: string;
    deviceId?: string;
...
export interface CreateLabeledFirmwareRequestParams {
    collectionId: string;
    version?: string;
    label?: string;
    imageRef?: string;
...
export interface DeleteLabeledImageRequestParams {
    collectionId: string;
    imageId: string;
}
...
export interface GetImageStateRequestParams {
    collectionId: string;
    deviceId: string;
}
...
export interface ListImageStatesRequestParams {
    collectionId: string;
}

export interface ListImageVersionHistoryRequestParams {
    collectionId: string;
    deviceId: string;
}

export interface ListLabeledFirmwareRequestParams {
    collectionId: string;
}
...
export class FotaService {
     ...
     */
    public assignTargetImage(requestParameters: AssignTargetImageRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<AssignTargetImageResponse>;
    public assignTargetImage(requestParameters: AssignTargetImageRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<AssignTargetImageResponse>>;
    public assignTargetImage(requestParameters: AssignTargetImageRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<AssignTargetImageResponse>>;
    public assignTargetImage(requestParameters: AssignTargetImageRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const collectionId = requestParameters.collectionId;
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling assignTargetImage.');
        }
        const imageId = requestParameters.imageId;
        if (imageId === null || imageId === undefined) {
            throw new Error('Required parameter imageId was null or undefined when calling assignTargetImage.');
        }
        ...
        let localVarPath = `/span/collections/${this.configuration.encodeParam({name: "collectionId", value: collectionId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/firmware/labeled/${this.configuration.encodeParam({name: "imageId", value: imageId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/assign`;
        return this.httpClient.request<AssignTargetImageResponse>('patch', `${this.configuration.basePath}${localVarPath}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createLabeledFirmware(requestParameters: CreateLabeledFirmwareRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CreateLabeledFirmwareResponse>;
    public createLabeledFirmware(requestParameters: CreateLabeledFirmwareRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CreateLabeledFirmwareResponse>>;
    public createLabeledFirmware(requestParameters: CreateLabeledFirmwareRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CreateLabeledFirmwareResponse>>;
    public createLabeledFirmware(requestParameters: CreateLabeledFirmwareRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const collectionId = requestParameters.collectionId;
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling createLabeledFirmware.');
        }
        const version = requestParameters.version;
        const label = requestParameters.label;
        const imageRef = requestParameters.imageRef;
        ...
        let localVarPath = `/span/collections/${this.configuration.encodeParam({name: "collectionId", value: collectionId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/firmware/labeled`;
        return this.httpClient.request<CreateLabeledFirmwareResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteLabeledImage(requestParameters: DeleteLabeledImageRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<object>;
    public deleteLabeledImage(requestParameters: DeleteLabeledImageRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public deleteLabeledImage(requestParameters: DeleteLabeledImageRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public deleteLabeledImage(requestParameters: DeleteLabeledImageRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const collectionId = requestParameters.collectionId;
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling deleteLabeledImage.');
        }
        const imageId = requestParameters.imageId;
        if (imageId === null || imageId === undefined) {
            throw new Error('Required parameter imageId was null or undefined when calling deleteLabeledImage.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getImageState(requestParameters: GetImageStateRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetImageStateResponse>;
    public getImageState(requestParameters: GetImageStateRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetImageStateResponse>>;
    public getImageState(requestParameters: GetImageStateRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetImageStateResponse>>;
    public getImageState(requestParameters: GetImageStateRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const collectionId = requestParameters.collectionId;
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling getImageState.');
        }
        const deviceId = requestParameters.deviceId;
        if (deviceId === null || deviceId === undefined) {
            throw new Error('Required parameter deviceId was null or undefined when calling getImageState.');
        }
        ...
        let localVarPath = `/span/collections/${this.configuration.encodeParam({name: "collectionId", value: collectionId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/devices/${this.configuration.encodeParam({name: "deviceId", value: deviceId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/fotastate`;
        return this.httpClient.request<GetImageStateResponse>('patch', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listImageStates(requestParameters: ListImageStatesRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ListImageStatesResponse>;
    public listImageStates(requestParameters: ListImageStatesRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ListImageStatesResponse>>;
    public listImageStates(requestParameters: ListImageStatesRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ListImageStatesResponse>>;
    public listImageStates(requestParameters: ListImageStatesRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const collectionId = requestParameters.collectionId;
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling listImageStates.');
        }
        ...
        let localVarPath = `/span/collections/${this.configuration.encodeParam({name: "collectionId", value: collectionId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/firmware/labeled/states`;
        return this.httpClient.request<ListImageStatesResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listImageVersionHistory(requestParameters: ListImageVersionHistoryRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ListImageVersionHistoryResponse>;
    public listImageVersionHistory(requestParameters: ListImageVersionHistoryRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ListImageVersionHistoryResponse>>;
    public listImageVersionHistory(requestParameters: ListImageVersionHistoryRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ListImageVersionHistoryResponse>>;
    public listImageVersionHistory(requestParameters: ListImageVersionHistoryRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const collectionId = requestParameters.collectionId;
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling listImageVersionHistory.');
        }
        const deviceId = requestParameters.deviceId;
        if (deviceId === null || deviceId === undefined) {
            throw new Error('Required parameter deviceId was null or undefined when calling listImageVersionHistory.');
        }
        ...
        let localVarPath = `/span/collections/${this.configuration.encodeParam({name: "collectionId", value: collectionId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/devices/${this.configuration.encodeParam({name: "deviceId", value: deviceId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/fotalog`;
        return this.httpClient.request<ListImageVersionHistoryResponse>('patch', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listLabeledFirmware(requestParameters: ListLabeledFirmwareRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ListLabeledFirmwareResponse>;
    public listLabeledFirmware(requestParameters: ListLabeledFirmwareRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ListLabeledFirmwareResponse>>;
    public listLabeledFirmware(requestParameters: ListLabeledFirmwareRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ListLabeledFirmwareResponse>>;
    public listLabeledFirmware(requestParameters: ListLabeledFirmwareRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const collectionId = requestParameters.collectionId;
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling listLabeledFirmware.');
        }
        ...
        let localVarPath = `/span/collections/${this.configuration.encodeParam({name: "collectionId", value: collectionId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/firmware/labeled`;
        return this.httpClient.request<ListLabeledFirmwareResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
